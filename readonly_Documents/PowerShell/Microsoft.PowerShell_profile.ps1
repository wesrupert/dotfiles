oh-my-posh init pwsh --config "$PSScriptRoot\config.omp.json" | Invoke-Expression

# Aliases {{{

$env:DEV_ROOT = "$HOME\Code"
$env:WORK_ROOT = "$($env:DEV_ROOT)\work"

function Mk-Link ($target, $link) {
  New-Item -Path $link -ItemType SymbolicLink -Value $target
}
Set-Alias -Name ln -Value Mk-Link
