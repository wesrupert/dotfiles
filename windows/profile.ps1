oh-my-posh init pwsh --config 'C:\Users\wes\AppData\Local\Programs\oh-my-posh\themes\spaceshipfixed.omp.json' | Invoke-Expression
...
function Toggle-Theme {
    . C:\Users\wes\AppData\Local\Packages\Microsoft.WindowsTerminal_8wekyb3d8bbwe\LocalState\windowsTerminal_themeToggler.ps1 *> out-null
}
...
. "$PSScriptRoot\Microsoft.PowerShell_profile.after.ps1"
