...
&{
  foreach ($WTAppName in "Microsoft.WindowsTerminal_8wekyb3d8bbwe","Microsoft.WindowsTerminalPreview_8wekyb3d8bbwe") {
    $WTsettingsDir = Join-Path -Path $env:LocalAppData -ChildPath "\Packages\$WTAppName\LocalState\"
